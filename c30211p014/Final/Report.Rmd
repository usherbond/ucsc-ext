...
rm(rawDataInfo,sampleZoo,intZoo,Intervals,periodLength,pseudoDate,sampleData,intFreq)
ls()
```
...
The information from the wind rose is a good quick outlook of how to the winds distribute along the year. We have two flaws with this digram:
