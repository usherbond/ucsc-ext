...
*Median* : Is the middle value of a data set when ordered. If the data set has odd number of elements it is simply the middle element. If the data set has even number of elements then it is the average of the position $\frac{n}{2}$ and $\frac{n}{2}+1$ where $n$ is the number of elements.

*Mode* : Is the most common element in a data set.

On skewed right distributions:

*Mode < Median < Mean*

On skewed left distributions:
...
From stattrek.com: variance is the average squared deviation from the population mean, as defined by the following formula:
